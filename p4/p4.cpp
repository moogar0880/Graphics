...
void appInit( void ){
    ...
    points.push_back(new Point3(0,0,0));
    points.push_back(new Point3(0,1,0));
    points.push_back(new Point3(1,2,0));

    SweepSurface* sw = new SweepSurface(10, points);
    sw->setLocation(0,0,0);
    sw->setSize(1, 1, 1);

    Scene* sweepScene = new Scene("SweepSurface Scene");
    sweepScene->addObject(sw);
    allScenes.push_back(sweepScene);

    sw = new SweepSurface(10, myTexture, points);
    sw->setLocation(0,0,0);
    sw->setSize(1, 1, 1);

    sweepScene = new Scene("SweepSurface Texture Scene");
    sweepScene->addObject(sw);
    allScenes.push_back(sweepScene);
